const textConfig = {
  ...
  text2: "Anh chỉ có 1 câu hỏi duy nhất thui ạ.",
  text3: "Em có yêu anh hong ạ? ._.",
  text4: "Anh yêu em nhất thế giới này ạ!",
  text5: "Em bình thường :))",
  text6: "Yêu ơi là yêu <3",
  text7: "1 điều em chưa hài lòng về anh nào?",
  text8: "Anh yêu em nhiều hơn",
  text9: "Thật sự là đần mà ạ T.T",
